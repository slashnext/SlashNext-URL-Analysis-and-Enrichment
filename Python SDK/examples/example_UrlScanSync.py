...
Contains an example of the SlashNextUrlScanSync usage from SlashNextPhishingIR module.

@author: Saadat Abid
"""
from SlashNextPhishingIR import SlashNextUrlScanSync

url_scan_sync_action = SlashNextUrlScanSync(
