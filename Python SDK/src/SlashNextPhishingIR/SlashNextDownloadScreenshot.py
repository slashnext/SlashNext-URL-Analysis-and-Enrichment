...
class SlashNextDownloadScreenshot:
    """
    ...
    def name(self):
        ...
        """
        return 'slashnext-download-screenshot'
    ...
    def title(self):
        ...
        """
        return 'SlashNext Phishing Incident Response - Download Screenshot'
    ...
    def description(self):
        ...
        """
        return 'This actions downloads a screenshot of a web page against a previous URL scan request.'
    ...
    def execution(self, scanid, resolution='high'):
        ...
        state, response = snx_api_request(self.base_url, DL_SC_API, api_data)
